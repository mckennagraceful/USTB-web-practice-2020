<template>
	<view class="login">
		<view class="content">
			...
			<!-- 主体表单 -->
			<view class="main">
				<wInput v-model="identify" type="text" maxlength="50" placeholder="用户名/电话/电子邮箱"></wInput>
				...
				uni.request({
					...
					success: (res) => {
						...
						if(res.data.code==200){
							...
							//登录成功后，页面会自动跳转到app首页，并且把登录成功的用户对象保存到本地缓存中
							setTimeout(function() {
								uni.switchTab({
									url:"../home/home"
								}); 
